                ...
                <div class="container mx-auto p-6">
                    ...
                    <table class="w-full border border-black">
                        <thead>
                            <tr class="bg-gray-200">
                                <th class="border border-black p-2">Code Employé(e)</th>
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="border border-black p-2">
                                                ...
                                                <a href="add-affectation.jsp?codeemp=${employe.codeemp}"
                                                    class="px-3 py-1 bg-black text-white rounded-md hover:bg-green-700">Affecter</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:when>
                    ...
                    <div class="flex justify-center mt-6 space-x-4">
                        <a href="EmployeAdd"
                            ...
                            employé</a>
                        <a href="LieuList"
                            class="px-4 py-2 bg-black text-white font-bold rounded-md hover:bg-gray-800">Voir
                            les Lieux</a>
                    </div>
                </div>
            </body>
